...
Каждый из перечисленных объектов имеет уникальные поля и поведения, совокупно реализовано 57 классов/интерфейсов, более 160 полей и 47 ассоциаций, а маршруты presentation-слоя ассоциированы с репозиториями и сервисами инфраструктуры.
